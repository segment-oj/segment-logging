...
slog::logger::logger(slog::severity_level level) { this->set_severity_level(level); }
...
slog::logger& slog::logger::debug(const std::string& content) {
    this->log(slog::severity_level::debug, content);
}

slog::logger& slog::logger::info(const std::string& content) {
    this->log(slog::severity_level::info, content);
}

slog::logger& slog::logger::warning(const std::string& content) {
    this->log(slog::severity_level::warning, content);
}

slog::logger& slog::logger::error(const std::string& content) {
    this->log(slog::severity_level::error, content);
}